...
import org.smallbox.faraway.ui.panel.PanelBuild;
import org.smallbox.faraway.ui.panel.PanelCharacter;
import org.smallbox.faraway.ui.panel.PanelCrew;
import org.smallbox.faraway.ui.panel.PanelDebug;
import org.smallbox.faraway.ui.panel.PanelInfo;
import org.smallbox.faraway.ui.panel.PanelJobs;
import org.smallbox.faraway.ui.panel.PanelManager;
import org.smallbox.faraway.ui.panel.PanelConsole;
import org.smallbox.faraway.ui.panel.PanelPlan;
import org.smallbox.faraway.ui.panel.PanelRoom;
import org.smallbox.faraway.ui.panel.PanelScience;
import org.smallbox.faraway.ui.panel.PanelSecurity;
import org.smallbox.faraway.ui.panel.PanelShortcut;
import org.smallbox.faraway.ui.panel.PanelStats;
import org.smallbox.faraway.ui.panel.PanelSystem;
...
public class UserInterface {
	...
	public void onCreate(Game game) {
		...
		for (BasePanel panel: _panels) {
			panel.init(this, _interaction, new RenderEffect());
		}
...
//		MainRenderer.getInstance().invalidate();
	...
	public void onDraw(Renderer renderer, int update, long renderTime) {
		for (BasePanel panel: _panels) {
		...
		if (_message != null && renderer != null && _viewport != null) {
			renderer.draw(_message.border, _viewport.getRenderEffect());
			renderer.draw(_message.shape, _viewport.getRenderEffect());
			renderer.draw(_message.text, _viewport.getRenderEffect());
			if (--_message.frame < 0) {
				_message = null;
			}
