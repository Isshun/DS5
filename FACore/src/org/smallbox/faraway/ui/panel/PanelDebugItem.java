...
public class PanelDebugItem extends BasePanel {
	...
	public PanelDebugItem(Mode mode, Key shortcut) {
		...
		_itemView = new FrameLayout(FRAME_WIDTH, FRAME_HEIGHT);
	...
	private void initGrid() {
		_grid = new FrameLayout(FRAME_WIDTH, FRAME_HEIGHT);
	...
	private View createGridItem(final ItemInfo item, int row, int col) {
		FrameLayout layout = new FrameLayout(COL_WIDTH, ROW_HEIGHT);
