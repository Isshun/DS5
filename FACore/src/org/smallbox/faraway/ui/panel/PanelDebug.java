...
public class PanelDebug extends BasePanel {
	...
	public PanelDebug(Mode mode, Key shortcut) {
		...
		// Add character
		TextView txtAddCharacter = new TextView(200, 32);
		...
		// Add Ressource
		TextView lbAddMatter = new TextView(200, 32);
		...
		// Items
		TextView lbItems = new TextView(200, 32);
		...
		// Re-launch jobs 
		TextView lbReLaunchJob = new TextView(200, 32);
		...
		// Clear jobs 
		TextView lbClearJob = new TextView(200, 32);
		...
		// Add seed 
		TextView lbAddSeed = new TextView(200, 32);
		...
		// Add water 
		TextView lbAddWater = new TextView(200, 32);
		...
		// Kill everyone 
		TextView lbKillEveryone = new TextView(200, 32);
		...
		// Reset light 
		TextView lbResetLight = new TextView(200, 32);
		...
		// Add dome 
		TextView lbDome = new TextView(200, 32);
