...
//	private Sprite 				_sprite2;
	...
	private SpriteModel _spriteCache;
...
//			_sprite.setTextureRect(new IntRect(16, 0, 16, 48));
	...
	public void onDraw(Renderer renderer, RenderEffect effect, double animProgress) {
		...
		if (_spriteCache == null) {
			_spriteCache = new SpriteModel();
            _spriteCache.getData().setTexture(_cache.getTexture());
		}
		
		renderer.draw(_spriteCache, new RenderStates(effect.getRender(), _blur));
	}
