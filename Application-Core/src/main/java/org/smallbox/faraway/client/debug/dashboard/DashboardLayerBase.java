...
public abstract class DashboardLayerBase {
    ...
    protected void drawDebug(GDXRenderer renderer, String label, Object object) {
        renderer.drawText(12, (index * 20) + 12, 18, Color.BLACK, "[" + label.toUpperCase() + "] " + object);
        renderer.drawText(11, (index * 20) + 11, 18, Color.BLACK, "[" + label.toUpperCase() + "] " + object);
        renderer.drawText(10, (index * 20) + 10, 18, Color.WHITE, "[" + label.toUpperCase() + "] " + object);
        index++;
    }
