...
//
//@GameObject
//public class JobModuleSerializer extends GameSerializer {
//
//    @Inject
//    private Game game;
//
...
//        sqlManager.post(db -> {
//            try {
//                db.exec("CREATE TABLE jobs (x INTEGER, y INTEGER, z INTEGER, area_id INTEGER)");
//
//                SQLiteStatement stStorage = db.prepare("INSERT INTO area_storage (id) VALUES (?)");
//                try {
//                    db.exec("begin transaction");
//                    jobModule.getAreas().forEach(storage -> {
//                        try {
