...
//            _renderer.setFullScreen(_isFullscreen);
            ...
            new ApplicationShortcut(PAGEUP, NONE, () -> {
                Application.notify(GameObserver::onFloorUp);
            }),
            new ApplicationShortcut(PAGEDOWN, NONE, () -> {
                Application.notify(GameObserver::onFloorDown);
            }),
...
//            }),
            ...
            new ApplicationShortcut(SPACE, NONE, () -> {
                Application.data.getBinding("base.binding.toggle_speed_0").action();
            }),

            new ApplicationShortcut(D_1, NONE, () -> {
                Application.data.getBinding("base.binding.set_speed_1").action();
            }),

            new ApplicationShortcut(D_2, NONE, () -> {
                Application.data.getBinding("base.binding.set_speed_2").action();
            }),

            new ApplicationShortcut(D_3, NONE, () -> {
                Application.data.getBinding("base.binding.set_speed_3").action();
            }),

            new ApplicationShortcut(D_4, NONE, () -> {
                Application.data.getBinding("base.binding.set_speed_4").action();
            }),
