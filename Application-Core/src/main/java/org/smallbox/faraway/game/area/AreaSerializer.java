...
//        });
    ...
    private void getAreaStorageItems(StorageArea storage, SQLiteStatement stItem, int areaId, DataManager dataManager) throws SQLiteException {
        stItem.bind(1, areaId);
        while (stItem.step()) {
            storage.setAccept(dataManager.getItemInfo(stItem.columnString(0)), true);
