ui:extend({
    ...
    views = {
        ...
        { type = "list", views = {
            ...
            { type = "label", text = "Item", text_color = blue_light_2, text_size = 12, margin = {12, 12, 0, 12}},
            { type = "label", id = "lb_name", text = "name", text_size = 28, text_color = blue_light_5, margin = {12, 12} },
