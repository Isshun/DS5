...
ui:extend({
    ...
    position = {10, 10},
    views = {
        { type = "label", text = "Plant", text_color = color1, text_size = 22},

        { type = "label", id = "lb_label", text_color = color2, text_size = 16},
        { type = "label", id = "lb_maturity", text_color = color2, text_size = 16},
        { type = "label", id = "lb_garden", text_color = color2, text_size = 16},
        { type = "label", id = "lb_seed", text_color = color2, text_size = 16},
        { type = "label", id = "lb_nourish", text_color = color2, text_size = 16},
        { type = "label", id = "lb_job", text_color = color2, text_size = 16},
        { type = "label", id = "lb_growing", text_color = color2, text_size = 16},

        { type = "label", text = "Parcel", text_color = color1, text_size = 22, margin = {60, 0, 0, 0}},
        ...
        { type = "label", text = "Encyclopedie", text_color = color1, text_size = 22, margin = {60, 0, 0, 0}},
        { type = "label", id = "lb_temperature", text_color = color2, text_size = 16},
        { type = "label", id = "lb_light", text_color = color2, text_size = 16},
        { type = "label", id = "lb_moisture", text_color = color2, text_size = 16},
        { type = "label", id = "lb_oxygen", text_color = color2, text_size = 16},
