...
UserInterfaceScience::UserInterfaceScience(sf::RenderWindow* app, int tileIndex)
  : UserInterfaceBase(app, tileIndex) {
  _textureTile.loadFromFile("../res/bg_tile_science.png");
  _texturePanel.loadFromFile("../res/bg_panel_science.png");
}

UserInterfaceScience::~UserInterfaceScience() {
}

void UserInterfaceScience::refreshSciences(int frame, long interval) {
...
void	UserInterfaceScience::draw(int frame) {
  // if (_isOpen) {
  // 	drawPanel(frame);
  // }
  drawTile();
...
void	UserInterfaceScience::drawTile() {
...
bool	UserInterfaceScience::checkKey(sf::Keyboard::Key key) {
