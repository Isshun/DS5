...
//import org.smallbox.faraway.game.model.job.CraftJob;
...
//
//        int index = 0;
//        if (item.getJobs() != null && !item.getJobs().isEmpty() && item.getJobs().get(0) instanceof CraftJob && ((CraftJob)item.getJobs().get(0)).getReceipt() != null) {
//            OldReceiptModel receipt = ((CraftJob)item.getJobs().get(0)).getReceipt();
