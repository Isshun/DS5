...
//            UIFrame framePriority = _viewFactory.createFrameLayout(300, 24);
...
////        _lbTip.setTextSize(FONT_SIZE_TITLE);
...
//            if (_character.getJob() != null && _character.getJob() instanceof UseJob & _character.getJob().getItem() != null && _character.getJob().getItem().isSleepingItem()) {
