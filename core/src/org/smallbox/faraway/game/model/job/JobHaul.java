...
//    }
//
//    public static JobHaul create(ConsumableModel consumable, StorageAreaModel bestStorage) {
//        if (consumable == null) {
...
//        if (_storage != null) {
//            _targetParcel = _storage.getNearestFreeParcel(consumable);
