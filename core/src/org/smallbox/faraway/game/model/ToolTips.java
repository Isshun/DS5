...
public class ToolTips {
	...
	public static final ToolTip RES_SCIENCE = new ToolTip("Science", "science");
	...
	public static final ToolTipCategory[] categories = {
		...
		new ToolTipCategory("Resources", new ToolTip[] {RES_FOOD, RES_GASOLINE, RES_SCIENCE, RES_OXYGEN, RES_POWER, RES_SPICE, RES_WATER}),
