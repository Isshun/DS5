...
public class CharacterName {
	...
	final static String[] femaleFirstName = {
			"Mary",
			"Patricia",
			"Linda",
			"Barbara",
	...
	final static String[] maleMiddlename = {
			"Yolo",
			"Tepren",
			"Ocan",
			"Loran",
	...
	final static String[] femaleMiddlename = {
			"Gatt",
			"Planis",
			"Ganna",
			"Oïane",
	...
	//		return middlename[(int)(Math.random() * 10000) % middlename.length];
	//	}

	public static String getLastName() {
		return lastname[(int)(Math.random() * 10000) % lastname.length];
	}
