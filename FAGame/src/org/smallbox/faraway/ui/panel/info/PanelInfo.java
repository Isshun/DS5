...
//		// Area
//		ParcelModel area = _ui.getSelector().getSelectedArea();
...
//
//		// Item
//		if (_ui.getSelector().getSelectedItem() != null) {
//			clean();
//			refreshItem(_ui.getSelector().getSelectedItem());
//		}
//
//		if (_ui.getSelector().getSelectedResource() != null) {
//			clean();
//			displayResource(_ui.getSelector().getSelectedResource());
//			return;
//		}
//
//		// ItemInfo
