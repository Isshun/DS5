...
public class ShaderTestApp extends ApplicationAdapter {
    ...
    public static void main (String[] arg) {
        new LwjglApplication(new ShaderTestApp(), DependencyManager.getInstance().createAndInit(LwjglConfig.class).getLwjglConfig());
    }

    @Override
    public void create () {
        /* Some regular textures to draw on the scene. */
        outline = new Texture("data/shader/smiley_outline.png");
        color = new Texture("data/shader/smiley_color.png");
        ...
        vertexShader = Gdx.files.internal("data/shader/vertex.glsl");
        fragmentShader = Gdx.files.internal("data/shader/fragment.glsl");
