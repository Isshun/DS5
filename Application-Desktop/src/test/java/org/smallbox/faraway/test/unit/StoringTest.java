...
//
//                    Collection<ConsumableItem> consumables = ((BasicStoreJob)job).getConsumables();
...
//                    Assert.assertEquals(1, jobModule.getJobs().size());
//
//                    Collection<ConsumableItem> consumables = ((BasicStoreJob)jobModule.getJobs().stream().findFirst().get()).getConsumables();
