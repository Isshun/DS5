...
public class DependencyInjector {
    ...
    private List<InjectListener> injectListeners = new ArrayList<>();
...
//        throw new RuntimeException("Cannot call register for class: " + component.getClass());
    ...
    public void injectDependencies() {
        ...
        _objectPool.forEach(host -> {
            ...
            doInjectConfig(host);
            injectListeners.forEach(listener -> listener.onInject(host));
...
//    }
    ...
    public interface InjectListener {
        void onInject(Object host);
    }

    public void addInject(InjectListener listener) {
        this.injectListeners.add(listener);
    }
