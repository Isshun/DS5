ui:extend({
    ...
    visible = false,
    views = {
        { type = "label", text = "Stand-by", text_size = 42, text_color = 0x25c9cbff, position = {20, application.info.screen_height - 52}},
        { type = "view", id = "bt_cursor", background = 0x25c9cbff, size = {20, 32}, position = {210, application.info.screen_height - 52}},
