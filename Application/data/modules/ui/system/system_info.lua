...
ui:extend({
    ...
    views = {
        ...
        { type = "view", align = {"top", "right"}, position = {0, 0}, background = 0x203636, size = {372, 38}, views = {
            ...
            { type = "label", id = "lb_weather", text = "weather", text_color = color2, text_size = 16, position = {188, 3}, padding = 10 },

            -- Temperature
            { type = "label", id = "lb_temperature", text = "tmp", text_color = color2, text_size = 16, position = {300, 3}, padding = 10 },
