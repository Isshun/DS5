ui:extend({
    ...
    in_game = false,
    views = {
        { type = "view", id = "bg_load", size = {application.info.screen_width, application.info.screen_height}, background = 0x121c1e},
        { type = "view", size = {200, 200}, position = {application.info.screen_width / 2 - 100, application.info.screen_height / 2 - 40}, views = {
