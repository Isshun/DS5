ui:extend({
    ...
    views = {
        ...
        { type = "grid", columns = 5, column_width = 50, row_height = 42, position = {110, 16}, views = {
            { type = "label", text = "1", id = "btPriority1", text_color = color1, text_size = 14, padding = {8, 18}, size = {40, 26}, background = 0x223355 },
            { type = "label", text = "2", id = "btPriority2", text_color = color1, text_size = 14, padding = {8, 18}, size = {40, 26}, background = 0x223b55 },
            { type = "label", text = "3", id = "btPriority3", text_color = color1, text_size = 14, padding = {8, 18}, size = {40, 26}, background = 0x224455 },
            { type = "label", text = "4", id = "btPriority4", text_color = color1, text_size = 14, padding = {8, 18}, size = {40, 26}, background = 0x224b55 },
            { type = "label", text = "5", id = "btPriority5", text_color = color1, text_size = 14, padding = {8, 18}, size = {40, 26}, background = 0x225555 },
        }},
