...
//        point2DS[0] = new Point2D.Double(0, 0);
//        point2DS[1] = new Point2D.Double(1, 0);
//        point2DS[2] = new Point2D.Double(2, 1);
//        point2DS[3] = new Point2D.Double(2, 2);
//
//        Spline2D spline2D = new Spline2D(point2DS);
//        spline2D.checkValues();
//    }
//
//    /**
