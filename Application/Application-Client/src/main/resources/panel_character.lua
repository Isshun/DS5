    ...
    views = {
        ...
        { type = "view", size = {400, 40}, position = {12, 0}, views = {
            { type = "grid", columns = 10, column_width = tab_width, row_height = 40, views = {
                { type = "view", action="onOpenStatus", background = 0xff359f9f, size = {tab_width, 40}, views = {
                ...
                { type = "view", action="onOpenInventory", background = 0xff359f9f, size = {tab_width, 40}, views = {
                ...
                { type = "view", action="onOpenInfo", background = 0xff359f9f, size = {tab_width, 40}, views = {
                ...
                { type = "view", action="onOpenSkill", background = 0xff359f9f, size = {tab_width, 40}, views = {
                ...
                { type = "view", action="onOpenHealth", background = 0xff359f9f, size = {tab_width, 40}, views = {
                ...
                { type = "view", action="onOpenTimetable", background = 0xff359f9f, size = {tab_width, 40}, views = {
        ...
        { type = "view", size = {400, 1}, background = 0xff359f9f },
