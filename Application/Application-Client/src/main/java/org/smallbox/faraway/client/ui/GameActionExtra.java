...
//        }
    ...
    public void actionPlan(int x, int y, int z) {
        ...
        switch (_selectedPlan) {
            case "unload":
                planDestroy(WorldHelper.getParcel(x, y, z));
                break;
            case "gather":
                planGather(x, y, z);
                break;
            case "dig":
                planMining(x, y, z, DigMode.FRONT);
                break;
            case "dig_hole":
                planMining(x, y, z, DigMode.HOLE);
                break;
            case "dig_ramp_up":
                planMining(x, y, z, DigMode.RAMP_UP);
                break;
            case "dig_ramp_down":
                planMining(x, y, z, DigMode.RAMP_DOWN);
                break;
            case "pick":
                planPick(x, y, z);
                break;
