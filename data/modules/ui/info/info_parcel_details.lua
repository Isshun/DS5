...
data:extend({
    ...
    views = {
        { type = "list", position = {10, 10}, views = {
            ...
            { type = "label", id = "lb_water", text_size = 14},
            { type = "label", id = "lb_light", text_size = 14},
            { type = "label", id = "lb_temperature", text_size = 14},
            { type = "label", id = "lb_walkable", text_size = 14},
            { type = "label", id = "lb_room", text_size = 14},
            { type = "label", id = "lb_rock", text_size = 14},
            { type = "label", id = "lb_structure", text_size = 14},
            { type = "label", id = "lb_consumable", text_size = 14},
            { type = "label", id = "lb_item", text_size = 14},
            { type = "label", id = "lb_plant", text_size = 14},
            { type = "label", id = "lb_network", text_size = 14},
        }},
    },
