...
--                { type = "image", id = "img_map", background = 0x000000, size = {380, 240}},
            ...
            { type = "grid", columns = 20, column_width = 30, row_height = 38, background = 0x203636, size = {352, 34}, views = {
                ...
                { type = "label", text = "H", text_size = 16, padding = 7, position = {4, 6}, size = {24, 24}, background = {regular = 0x203636, focus = 0x203636}, id = "lb_display_temperature", on_click = function(v) application:toggleDisplay("temperature") end},
