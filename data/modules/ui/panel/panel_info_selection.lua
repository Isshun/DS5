    ...
    views = {
        ...
        { type = "view", size = {348, 500}, background = color2, views = {
            ...
            { type = "list", size = {346, 499}, position = {1, 0}, background = 0x144143ff, views = {
                ...
                { type = "label", text = "Ground", text_color = color1, text_size = 14, margin = {12, 12, 0, 12}},
                { type = "label", id = "lb_ground", text = "ground", text_size = 20, text_color = color2, margin = {12, 12} },

                { type = "label", text = "Rock", text_color = color1, text_size = 14, margin = {12, 12, 0, 12}},
                { type = "label", id = "lb_rock", text = "rock", text_size = 20, text_color = color2, margin = {12, 12} },

                { type = "label", text = "Item", text_color = color1, text_size = 14, margin = {12, 12, 0, 12}},
                { type = "label", id = "lb_item", text = "item", text_size = 20, text_color = color2, margin = {12, 12} },

                { type = "label", text = "Consumable", text_color = color1, text_size = 14, margin = {12, 12, 0, 12}},
                { type = "label", id = "lb_consumable", text = "consumable", text_size = 20, text_color = color2, margin = {12, 12} },
