ui:extend({
    ...
    views = {
        ...
        { type = "view", id = "view_weather", align = {"top", "right"}, position = {0, 0}, background = 0x203636ff, size = {373, 38}, views = {
            ...
            { type = "label", id = "lb_time", text_color = blue_light_5, text_size = 16, position = {50, 7} },
            { type = "label", id = "lb_date", text_color = blue_light_5, text_size = 12, position = {38, 24} },

            -- Weather
            { type = "label", id = "lb_weather", text_color = blue_light_5, text_size = 16, text_align = "RIGHT", position = {230, 7}},
            { type = "label", id = "lb_temperature", text_color = blue_light_5, text_size = 12, text_align = "RIGHT", position = {230, 24}},
            ...
            { type = "label", id = "lb_speed", text_color = blue_light_5, text_size = 16, position = {200, 4}},
