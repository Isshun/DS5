data:extend({
    ...
    views = {
        ...
        { type = "list", position = {application.info.screen_width / 2 - 300 / 2, application.info.screen_height / 2 - 200}, views = {
            { type = "label", text = "Continue", text_size = 22, padding = 16, background = {regular = 0x55ffffff, focus = 0x8814dcb9}, size = {280, 48}, margin = {10, 0, 0, 10}, on_click = function() application:startLastGame() end},
