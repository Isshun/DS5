...
//
//public class PanelInfoCharacterModule extends GameUIModule {
...
//	}
//
//	private class PanelInfoCharacterModuleWindow extends UIWindow {
...
//				refreshDebug();
//
//				((UILabel)findById("lb_body_heat")).setText("Body heat: " + (int) (_character.getBodyHeat() * 10) / 10f);
//			}
//
//			refreshTalents();
//			refreshTimeTable();
...
//
//				UILabel lbPriority = ViewFactory.getInstance().createTextView();
//				lbPriority.setText(priority.name + " (" + (int) priority.level + ")");
//				lbPriority.setTextSize(16);
//				lbPriority.setPosition(0, 8);
//				lbPriority.resetSize();
//				framePriority.addView(lbPriority);
//
//				ColorView bgProgress = ViewFactory.getInstance().createColorView(32, 2);
//				bgProgress.setPosition(240, 21);
//				bgProgress.setBackgroundColor(0x555555);
//				framePriority.addView(bgProgress);
//
//				ColorView frameProgress = ViewFactory.getInstance().createColorView(20, 2);
...
//
//			findById("lb_info_gender").setOnClickListener(view -> UserInterface.getInstance().getSelector().select(ToolTips.GENDER));
//
...
//				_familyEntries[i].setTextSize(FONT_SIZE);
...
//				_familyRelationEntries[i].setTextSize(FONT_SIZE);
...
////					}
////
////					_familyEntries[i].setText(StringUtils.getDashedString(left, relationName, NB_COLUMNS));
////
////					i++;
////				}
////			}
...
////				if (i == 0) {
////					_familyEntries[i].setText("no results");
////					_familyEntries[i].setStyle(UILabel.REGULAR);
////					_familyRelationEntries[i].setText("");
////				} else {
////					_familyEntries[i].setText("");
////					_familyRelationEntries[i].setText("");
////				}
////			}
////		}
...
//			((UILabel) findById("lb_ethnic_group")).setText(null);
...
////					}
////					((UILabel) findById("lb_stats_buff")).setText(buffValue);
////
...
////					}
////					((UILabel) findById("lb_stats_absorb")).setText(absorbValue);
////
...
////					}
////					((UILabel) findById("lb_stats_resist")).setText(resistsValue);
////
////					((UILabel) findById("lb_ethnic_group")).setText(body);
////				}
////			}
//		}
//
...
//			}
//			((UILabel) findById("lb_total_buff")).setText(buffValue);
//
//			String absorbValue = "Absorb ";
...
//			}
//			((UILabel) findById("lb_total_absorb")).setText(absorbValue);
//
//			String resistsValue = "Resists ";
...
//			}
//			((UILabel) findById("lb_total_resist")).setText(resistsValue);
//		}
//
...
//				lbRow.setText(" " + (h < 9 ? " " : "") + (h + 1) + "h");
//				lbRow.setTextSize(14);
//				lbRow.setPosition(0, 21 * h);
//				lbRow.setTextAlign(Align.CENTER_VERTICAL);
...
//				}
//				((UILabel) findById("lb_equipment_total_resist")).setText("Resists: " + String.join(", ", resists));
//
...
//				}
//				((UILabel) findById("lb_equipment_total_absorb")).setText("Absorbs: " + String.join(", ", absorb));
//
...
//				}
//				((UILabel) findById("lb_equipment_total_buff")).setText("Buffs: " + String.join(", ", buff));
//			}
//		}
//
...
//				((UILabel) findById("lb_health")).setText(_character.getStats().deathMessage);
//			}
//
...
//				_lbDiseases[line].setText(disease.message);
//				line++;
//			}
//			for (; line < NB_MAX_DISEASES; line++) {
//				_lbDiseases[line].setText("");
//			}
//		}
//
...
//				}
//			} else {
//				_lbJob.setText(Strings.LN_NO_JOB);
//				_lbJob.setOnClickListener(null);
//			}
//		}
//
//		private void refreshInventory() {
//			_lbInventory.setText(Strings.LB_INVENTORY);
////        _lbInventory.setText(StringUtils.getDashedString(Strings.LB_INVENTORY,
////                _character.getInventorySpace() - _character.getInventoryLeftSpace() + "/" + _character.getInventorySpace(), 29));
//
//			((UILabel) findById("lb_inventory_entry")).setText(_character.getInventory() != null ?
...
////                            resists.add(entry.getKey() + ": " + (entry.getValue() > 0 ? "+" + entry.getValue() : entry.getValue()));
////                        }
////                        ((UILabel)findById("lb_equipment_resist")).setText("[R]: " + String.join(", ", resists));
////                    }
////
////                    // Check debuff
////                    if (effect.debuff != null) {
...
////                        }
////                        ((UILabel)findById("lb_equipment_absorb")).setText("[A]: " + String.join(", ", absorbs));
////                    }
////
////                    // Check buff
////                    if (effect.buff != null) {
...
////                        }
////                        ((UILabel)findById("lb_equipment_resist")).setText("[B]: " + String.join(", ", buffs));
////                    }
////                }
////            }
//			}
...
//			_animLabel.setText(_animValue.substring(0, pos));
...
//	}
//
//	private PanelInfoCharacterModuleWindow _window;
//
//	@Override
//	protected void onLoaded() {
//		_window = new PanelInfoCharacterModuleWindow();
//		addWindow(_window);
//	}
//
//	@Override
