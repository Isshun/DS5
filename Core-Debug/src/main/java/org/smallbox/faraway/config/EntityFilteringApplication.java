 ...
 * holder.
 */
package org.smallbox.faraway.config;
...
//        fileAppender.setFile(Paths.get(System.getenv("LOCALAPPDATA"), "Gremlins", "gremlins.log").toString());
...
//        Logger.getRootLogger().addAppender(fileAppender);
    ...
    public EntityFilteringApplication() {
        ...
        packages("org.smallbox.faraway");
        packages("org.glassfish.jersey.examples.multipart");
//        packages("org.glassfish.jersey.examples.jsonmoxy");

        property("log4j.debug", true);
        property("log4jConfigLocation", "/WEB-INF/log4j.properties");

//        property("jersey.config.server.mvc.templateBasePath.jsp", "WEB-INF/jsp");
//        property(JspMvcFeature.TEMPLATE_BASE_PATH, "/WEB-INF/jsp");
//        property("jersey.config.servlet.filter.staticContentRegex", "/(resources|(WEB-INF/jsp))/.*");
